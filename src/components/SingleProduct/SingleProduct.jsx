  ...
  return (
    ...
    <Container className="product-view">
      ...
      <Grid container spacing={4}  className={classes.mainProd}>
        ...
        <Grid item xs={12} md={4}  className={classes.container + " container1"}>
          <Typography variant="h2">{product.name}</Typography>
          <Typography dangerouslySetInnerHTML={{__html: product.description}} className={classes.descrizione} variant="body2" color="textSecondary"/>

          <Typography variant="h4">
            Prezzo del prodotto: {product.price}
            <br/>
          </Typography>
          <Grid container spacing={4}>
            <Grid item xs={12} >
              ...
              <Button size="large" variant="contained" style={{marginLeft:"10px"}} onClick={() => {
                  handleQuantity(1);
                }}
              >
                +
